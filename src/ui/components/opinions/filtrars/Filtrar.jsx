 ...
 const calendarClose=(event)=>{
  ...
  return (
    <Paper className={classes.container}>
      <Box className={classes.boxTitleFilter}>
        <Typography className={classes.textTitle}>Filtrar
      ...
      <Box className={classes.todoComponents}>
        ...
        <Divider className={classes.hrDate}/>
        <Box className={classes.todoMaterial}>
              ...
              <Box className={classes.boxMaterial}>
                ...
                <Divider className={classes.hrMaterials}/>
            </Box>
